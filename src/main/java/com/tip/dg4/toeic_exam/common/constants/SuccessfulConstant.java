...
public class SuccessfulConstant {
    ...
    public static final String VOCABULARY_CATEGORY_S005 = "Get vocabulary category successfully";
    //  Vocabulary
    public static final String VOCABULARY_S001 = "Get all vocabularies successfully";
    ...
    public static final String LESSON_S003 = "The lesson was updated successfully";
    public static final String LESSON_S004 = "The lesson was deleted successfully";
    public static final String LESSON_S005 = "Get the lesson successfully";
    //  Content
